...
(function init(){
  ...
  fetch(`${API_BASE}/users`, { headers: { "Authorization": `Bearer ${token}` } })
    ...
    .then(user => { const welcome = document.getElementById("welcome"); if (welcome) welcome.textContent = `Hoş geldin, ${user.username}`; })
  ...
  document.getElementById("logout-btn")?.addEventListener("click", () => {
    localStorage.removeItem("jwtToken"); window.location.href = "auth.html";
  });
})();
